...
const ExperienceDetailsConstants = {
  '2016': {
    ...
    'PCCW Solutions': {
      ...CompaniesConstants['PCCW Solutions'],
  ...
  '2018': {
    'Indra Philippines': {
      ...CompaniesConstants['Indra Philippines'],
  ...
  '2020': {
    'Prosource Global': {
      ...CompaniesConstants['Prosource Global'],
...
export { ExperienceDescriptionConstants, ExperienceDetailsConstants, ExperienceSkillsConstants, CompaniesConstants };